...
//   const hasCentered = useRef(false); // ✅ Added flag to prevent multiple fitBounds
...
//         bounds.extend({ lat: pro.latitude, lng: pro.longitude });
//       });
...
//   // ✅ Only fitBounds on first professionals load
//   useEffect(() => {
//     if (
//       !mapRef.current ||
...
//       ),
//       PROFESSIONAL_FIRST_RESPONSDER: iconToDataUrl(
...
//         <p className="text-gray-600 text-lg">Loading professionals on map...</p>
//       </div>
//     );
//   }
