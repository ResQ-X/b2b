...
export default function PaymentDetailsModal({
  ...
  const [type, setType] = useState<"TOP_UP" | "SUBSCRIPTION">("SUBSCRIPTION");
  ...
  const handleSubmit = async () => {
    ...
    if (type === "SUBSCRIPTION" && !subMonths) {
      toast.error("Please select subscription months");
      return;
    }
    ...
    try {
      ...
      if (type === "SUBSCRIPTION") {
        requestData.sub_months = parseInt(subMonths);
          ...
          <div>
            ...
            <div className="relative">
              <select
                value={type}
                onChange={(e) =>
                  setType(e.target.value as "TOP_UP" | "SUBSCRIPTION")
                }
