              ...
              <TableBody>
                {orders.slice(0, 5).map((order) => (
                  <TableRow key={order?.id}>
                    ...
                    <TableCell>
                      {order.from_address || order.location}
                    </TableCell>
                    <TableCell>
                      {order.created_at
